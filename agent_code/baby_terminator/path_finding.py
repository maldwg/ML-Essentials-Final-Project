...
def astar(start, goal, field):
    ...
    while open_set:
        ...
        for dx, dy in DIRECTIONS:
            ...
            if neighbor[0] < 0 or neighbor[0] >= field.shape[0] or neighbor[1] < 0 or neighbor[1] >= field.shape[1]:
                continue

            if field[neighbor] == -1 or field[neighbor] == 1:  # Obstacle or unwalkable cell
                continue
